              ...
              <div class="col-12 col-md-6 col-lg-4">
                  <div class="single-latest-sermons mb-100">
                      ...
                      <div class="sermons-content">
                          ...
                          <h4>MỪNG XUÂN KỶ HỢI 2019</h4>
                          <div class="sermons-meta-data">
                              <p><i class="fa fa-user" aria-hidden="true"></i> Bài Viết: <span>Lm Phanxico Trần Quốc Tuấn</span></p>
                              <p><i class="fa fa-tag" aria-hidden="true"></i> Categories: <span>God, Pray</span></p>
                              <p><i class="fa fa-clock-o" aria-hidden="true"></i> Feb 3 on <span>9:00 am - 11:00 am</span></p>
                          </div>
                      </div>
                  </div>
              </div>
              ...
              <div class="col-12 col-md-6 col-lg-4">
                  <div class="single-latest-sermons mb-100">
                      ...
                      <div class="sermons-content">
                          ...
                          <h4>QUỸ HẰNG NĂM CỦA ĐỨC TỔNG GIÁM MỤC - AAA</h4>
                          <div class="sermons-meta-data">
                              <p><i class="fa fa-user" aria-hidden="true"></i> Bài Viết: <span>Lm Phanxico Trần Quốc Tuấn</span></p>
                              <p><i class="fa fa-tag" aria-hidden="true"></i> Categories: <span>God, Pray</span></p>
                              <p><i class="fa fa-clock-o" aria-hidden="true"></i> Feb. 10 on <span>10:00 am - 11:00 am</span></p>
                          </div>
                      </div>
                  </div>
              </div>
                  ...
                  <div class="single-latest-sermons mb-100">
                      ...
                      <div class="sermons-content">
                          ...
                          <div class="sermons-meta-data">
                              <p><i class="fa fa-user" aria-hidden="true"></i> Bài Viết: <span>Lm Phanxico Trần Quốc Tuấn</span></p>
                              <p><i class="fa fa-tag" aria-hidden="true"></i> Categories: <span>God, Pray</span></p>
                              <p><i class="fa fa-clock-o" aria-hidden="true"></i> Feb. 17 on <span>9:00 am - 11:00 am</span></p>
                          </div>
                      </div>
                  </div>
              </div>
